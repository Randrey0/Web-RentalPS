                            ...
                            ?>
                                <tr>
                                    ...
                                    <form action="<?= base_url('pinjam/pinjamAct/' . $p['id_booking']); ?>" method="post">
                                        <td nowrap>
                                            <button type="submit" class="btn btn-sm btn-outline-info"><i class="fas fa-fw fa-cart-plus"></i> Kirim</button>
                                        </td>
                                        <td>
                                    ...
                                    <td>
                                        <a href="<?= base_url('booking/hapusSewa/') . $p['id_booking']; ?>" onclick=" confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $p['id_booking']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                            <?php $no++;
                            } ?>
