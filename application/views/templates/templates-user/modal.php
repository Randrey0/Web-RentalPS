                         ...
                         <form action="<?= base_url('member/daftar'); ?>" method="post">
                             <div class="modal-body">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                     <input type="text" class="form-control form-control-user" id="no_telpon" name="no_telpon" placeholder="Nomer Telpon Aktif">
                                 </div>
                                 <div class="form-group">
            ...
            <div class="modal fade" tabindex="-1" id="modalinfo" role="dialog">
                 <div class="modal-dialog" role="document">
                     <div class="modal-content">
                         ...
                         <div class="modal-body">
                            <span class="alert alert-message alert-success">Waktu Pengiriman Console 1x24 jam dari Waktu Anda Menyewa!!!</span>
                         </div>
                         <div class="modal-footer">
