...
<html>
<head>
	<title>Dashboard - Aplikasi Rental PS 🎮</title>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">RentalPs 🎮</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'console'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Console</a></li>
					<li><a href="<?php echo base_url().'member'; ?>"><span class="glyphicon glyphicon-user"></span> Data Member</a></li>
