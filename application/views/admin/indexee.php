			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_perpus->get_data('console')->num_rows(); ?></b></font>
						</div>
						<div><b>Jumlah Console yang Terdaftar</b></div>
					</div>
				</div>
			</div>
			<a href="<?php echo base_url().'console' ?>">
		...
		<div class="panel panel-danger">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<font size="18"><b><?php echo $this->m_perpus->edit_data(array('status_pinjam'=>'Sudah Selesai'),'peminjaman')->num_rows(); ?></b></font>
						</div>
	...
	<div class="row">
		<div class="col-lg-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title" style="font-size: 18px; font-weight: bold;"><i class="glyphicon glyphicon-random arrow-right"></i> Console</h3>
				</div>
				<div class="panel-body">
					<div class="list-group">
						<?php foreach($console as $b){ ?>
							<a href="#" class="list-group-item">
								<span class="badge"><?php if($b->status_console == 1){echo "Tersedia";}else{echo "Dipinjam";}?></span>
								<i class="glyphicon glyphiconuser"></i> <?php echo $b->nama_console; ?>
							</a>
						<?php } ?>
					</div>
					<div class="text-right">
						<a href="<?php echo base_url().'admin/console' ?>">Lihat Semua Console <i class="glyphicon glyphicon-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
